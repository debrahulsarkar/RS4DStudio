  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-studio-bg px-4 py-[var(--section-padding)] sm:px-6 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        <Reveal>
          <SectionHeading align="center" eyebrow="Start" title="Ready to turn a character idea into a production-ready sculpt?" description=" Let's start with a tailored brief" />
